        ...
        <div class="row medium-padding120 bg-border-color">
            <div class="container">
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            ...
                            @foreach ($laravel->posts()->take(3)->get() as $item)
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    ...
                                    <h6 class="case-item__title"><a href="#">{{$item->title}}</a></h6>
                                </div>
                            </div>
                            @endforeach
                ...
                <div class="offers">
                    ...
                    <div class="row">
                        <div class="case-item-wrap">
                            @foreach ($wordpress->posts()->orderby('created_at', 'desc')->take(3)->get() as $item)
